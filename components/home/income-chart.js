...
import { colorsgreylight, colorsprimarylight, colorswhite } from '../../styles/colors';
import { Month, monthNames, shortenMonth } from '../../util/models/month';
import { totalIncome } from '../../util/helper';
export class IncomeChartComponent extends RxLitElement {
    render() {
        return html `
      <div>
    ...
    updated() {
        ...
        Object.keys(Month).forEach((m) => {
            ...
            calculatedNumbers[m] = totalIncome(entries);
        });
        if (!this.chart)
            return;
        const data = {
...
__decorate([
    state()
], IncomeChartComponent.prototype, "entries", void 0);
__decorate([
    query('#chart')
], IncomeChartComponent.prototype, "chart", void 0);
