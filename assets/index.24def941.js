var t=Object.defineProperty,e=Object.prototype.hasOwnProperty,r=Object.getOwnPropertySymbols,a=Object.prototype.propertyIsEnumerable,o=(e,r,a)=>r in e?t(e,r,{enumerable:!0,configurable:!0,writable:!0,value:a}):e[r]=a,i=(t,i)=>{for(var s in i||(i={}))e.call(i,s)&&o(t,s,i[s]);if(r)for(var s of r(i))a.call(i,s)&&o(t,s,i[s]);return t};import{g as s,s as n,a as l,b as c,c as d,D as p,U as h,d as g,A as v,x as u,E as m,e as y,l as E,f as b,h as f,q as w,R as C,i as I,u as A,j as x,k as O,C as N,m as k,r as L,n as D,o as S,p as T,t as G,v as M}from"./vendor.b76bae32.js";!function(t=".",e="__import__"){try{self[e]=new Function("u","return import(u)")}catch(r){const a=new URL(t,location),o=t=>{URL.revokeObjectURL(t.src),t.remove()};self[e]=t=>new Promise(((r,i)=>{const s=new URL(t,a);if(self[e].moduleMap[s])return r(self[e].moduleMap[s]);const n=new Blob([`import * as m from '${s}';`,`${e}.moduleMap['${s}']=m;`],{type:"text/javascript"}),l=Object.assign(document.createElement("script"),{type:"module",src:URL.createObjectURL(n),onerror(){i(new Error(`Failed to import: ${t}`)),o(l)},onload(){r(self[e].moduleMap[s]),o(l)}});document.head.appendChild(l)})),self[e].moduleMap={}}}("assets/");const _=(t,e)=>{customElements.get(t)||customElements.define(t,e)},$=t=>(...e)=>class extends t{constructor(){super(...e)}};var R,P,V,H,F,j,U,W;(P=R||(R={})).LOGGED_IN_SUCCESFULLY="[AppEvents: Logged In Succesfully]",P.CLICKED_LOG_IN="[AppEvents: Clicked Log In]",P.CLICKED_LOG_OUT="[AppEvents: Clicked Log Out]",P.CLICKED_HOME="[AppEvents: Clicked Home]",P.CLICKED_MONTHLY="[AppEvents: Clicked Monthly]",P.CLICKED_ADD_ENTRY="[AppEvents: Clicked Add Entry]",P.CLICKED_DELETE="[AppEvents: Clicked Delete]";class z{constructor(t,e){this.email=t,this.password=e,this.type=R.CLICKED_LOG_IN}}class B{constructor(){this.type=R.CLICKED_LOG_OUT}}class Y{constructor(){this.type=R.CLICKED_HOME}}class K{constructor(){this.type=R.CLICKED_MONTHLY}}class X{constructor(t){this.entry=t,this.type=R.CLICKED_ADD_ENTRY}}class Z{constructor(t){this.id=t,this.type=R.CLICKED_DELETE}}(H=V||(V={})).WINDOW="[AppState: Window]",H.DATA="[AppState: Data]",(j=F||(F={})).LOADING_DATA="[AppDataState: Loading Data]",j.ADDING_DATA="[AppDataState: Adding Data]",j.DELETEING_DATA="[AppDataState: Deleteing Data]",j.IDLE="[AppDataState: Idle]",(W=U||(U={})).VIEWING_LOGIN_PAGE="[AppWindowState: Viewing Login Page]",W.LOGGING_IN="[AppWindowState: Logging In]",W.LOGGING_OUT="[AppWindowState: Logging Out]",W.VIEWING_HOME_PAGE="[AppWindowState: Viewing Home Page]",W.VIEWING_MONTHLY_PAGE="[AppWindowState: Viewing Monthly Page]";const J={type:"parallel",id:"app",states:{[V.DATA]:{initial:F.IDLE,states:{[F.IDLE]:{id:F.IDLE,on:{[R.LOGGED_IN_SUCCESFULLY]:F.LOADING_DATA,[R.CLICKED_ADD_ENTRY]:F.ADDING_DATA,[R.CLICKED_DELETE]:F.DELETEING_DATA}},[F.LOADING_DATA]:{id:F.LOADING_DATA,invoke:{src:(t,e)=>async function(){const t=p(h(),s().currentUser.email),e=await g(t),r=[];return e.forEach((t=>{const e=t.data();r.push({id:t.id,amount:e.amount,year:e.year,month:e.month,description:e.description,categories:e.categories})})),r}(),onDone:{actions:y({data:(t,e)=>e.data}),target:F.IDLE},onError:{actions:E(((t,e)=>console.log("Error Loading Data:",e))),target:F.IDLE}}},[F.ADDING_DATA]:{id:F.ADDING_DATA,invoke:{src:(t,e)=>async function(t,e){if(!(e instanceof X))throw new Error("");console.log("Saving: ",e.entry);const r=p(h(),s().currentUser.email);delete e.entry.id;const a=await v(r,e.entry);return i(i({},e.entry),{id:a.id})}(0,e),onDone:{actions:y({data:(t,e)=>[...t.data,e.data]}),target:F.IDLE},onError:{actions:E(((t,e)=>console.log("Error Adding Data:",e))),target:F.IDLE}}},[F.DELETEING_DATA]:{id:F.DELETEING_DATA,invoke:{src:(t,e)=>async function(t,e){if(!(e instanceof Z))throw new Error("");console.log("Deleteing ID: ",e.id);const r=u(h(),s().currentUser.email,e.id);return await m(r),e.id}(0,e),onDone:{actions:y({data:(t,e)=>t.data.filter((t=>t.id!==e.data))}),target:F.IDLE},onError:{actions:E(((t,e)=>console.log("Error Deleteing Data:",e))),target:F.IDLE}}}}},[V.WINDOW]:{initial:U.LOGGING_IN,on:{[R.CLICKED_LOG_OUT]:`.${U.LOGGING_OUT}`,[R.CLICKED_HOME]:`.${U.VIEWING_HOME_PAGE}`,[R.CLICKED_MONTHLY]:`.${U.VIEWING_MONTHLY_PAGE}`},states:{[U.LOGGING_IN]:{invoke:{src:(t,e)=>async function(t,e){const r=s();if(await n(r,d),!r.currentUser){if(!(e instanceof z))throw new Error("Must be ClickedLogInEvent (Error can occur on initial load of app)");await l(r,e.email,e.password)}}(0,e),onDone:{actions:b(new class{constructor(){this.type=R.LOGGED_IN_SUCCESFULLY}}),target:U.VIEWING_HOME_PAGE},onError:{actions:E(((t,e)=>console.log("Error Logging In:",e))),target:U.VIEWING_LOGIN_PAGE}}},[U.VIEWING_LOGIN_PAGE]:{on:{[R.CLICKED_LOG_IN]:U.LOGGING_IN}},[U.VIEWING_HOME_PAGE]:{},[U.VIEWING_MONTHLY_PAGE]:{},[U.LOGGING_OUT]:{invoke:{src:(t,e)=>async function(){const t=s();await c(t)}(),onDone:U.VIEWING_LOGIN_PAGE,onError:U.VIEWING_LOGIN_PAGE}}}}}};function q(t,e){null==t||t.addEventListener("keypress",(t=>{"Enter"===t.key&&e()}))}const Q=f`
  body, html {
    width: 100%;
    height: 100%;
...
`;var tt='<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">\n<path d="M20.3287 11.0002V13.0002L7.50042 13.0002L10.7429 16.2428L9.32873 17.657L3.67188 12.0001L9.32873 6.34326L10.7429 7.75747L7.50019 11.0002L20.3287 11.0002Z"/>\n</svg>\n',et='<svg viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">\n  <path\n    clip-rule="evenodd"\n    d="M4.18179 6.18181C4.35753 6.00608 4.64245 6.00608 4.81819 6.18181L7.49999 8.86362L10.1818 6.18181C10.3575 6.00608 10.6424 6.00608 10.8182 6.18181C10.9939 6.35755 10.9939 6.64247 10.8182 6.81821L7.81819 9.81821C7.73379 9.9026 7.61934 9.95001 7.49999 9.95001C7.38064 9.95001 7.26618 9.9026 7.18179 9.81821L4.18179 6.81821C4.00605 6.64247 4.00605 6.35755 4.18179 6.18181Z"\n  />\n</svg>\n',rt='<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">\r\n  <path d="M16,2A14,14,0,1,0,30,16,14,14,0,0,0,16,2Zm0,26A12,12,0,1,1,28,16,12,12,0,0,1,16,28Z"/>\r\n  <circle cx="16" cy="23.5" r="1.5"/>\r\n  <path d="M17,8H15.5A4.49,4.49,0,0,0,11,12.5V13h2v-.5A2.5,2.5,0,0,1,15.5,10H17a2.5,2.5,0,0,1,0,5H15v4.5h2V17a4.5,4.5,0,0,0,0-9Z"/>\r\n</svg>',at='<?xml version="1.0" encoding="iso-8859-1"?>\r\n<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 201.865 201.865">\r\n\t<g>\r\n\t\t<path d="M200.65,105.892l-21.763-19.709V39.168c0-2.026-1.643-3.665-3.665-3.665h-19.158\r\n\t\t\tc-0.973,0-1.908,0.383-2.598,1.074c-0.691,0.691-1.077,1.625-1.066,2.602l0.05,23.059l-47.466-42.993\r\n\t\t\tc-1.389-1.256-3.482-1.267-4.889-0.032L1.247,106.278c-1.263,1.109-1.61,2.924-0.841,4.42c0.759,1.485,2.434,2.28,4.066,1.908\r\n\t\t\tl21.971-4.96v67.758c-0.021,0.591-0.032,3.647,2.18,5.944c0.981,1.009,2.738,2.222,5.569,2.222c5.282,0,49.027-0.054,49.027-0.054\r\n\t\t\tc2.029,0,3.661-1.643,3.665-3.665l0.057-40.509c-0.036-0.472,0.05-1.671,0.537-2.205c0.329-0.351,1.034-0.433,1.557-0.433h20.353\r\n\t\t\tc0.913,0,2.147,0.147,2.781,0.805c0.698,0.716,0.687,1.961,0.676,2.154l-0.093,40.058c0,0.97,0.379,1.904,1.07,2.598\r\n\t\t\tc0.687,0.687,1.632,1.081,2.598,1.081h48.003c3.264,0,5.268-1.378,6.363-2.527c2.559-2.663,2.473-6.313,2.459-6.564V106.54\r\n\t\t\tl24.111,5.64c1.643,0.39,3.307-0.39,4.091-1.868C202.225,108.834,201.896,107.019,200.65,105.892z M159.744,42.836h11.817v36.705\r\n\t\t\tl-11.76-10.651L159.744,42.836z M170.409,98.344c-1.081-0.258-2.24,0-3.11,0.698c-0.873,0.694-1.389,1.754-1.389,2.874v72.486\r\n\t\t\tc0,0.394-0.143,1.12-0.419,1.403c-0.225,0.222-0.762,0.251-1.07,0.251h-44.328l0.079-36.129c0.032-0.44,0.218-4.366-2.609-7.401\r\n\t\t\tc-1.356-1.435-3.858-3.153-8.181-3.153H89.029c-3.654,0-5.83,1.557-7.011,2.859c-2.516,2.788-2.473,6.524-2.409,7.573\r\n\t\t\tl-0.057,36.383c-10.629,0.011-41.017,0.05-45.366,0.05c-0.132,0-0.215-0.007-0.268-0.007c-0.007,0-0.018,0-0.025,0\r\n\t\t\tc-0.068-0.147-0.118-0.426-0.118-0.676v-72.493c0-1.113-0.515-2.169-1.381-2.867c-0.873-0.694-2.015-0.948-3.096-0.712\r\n\t\t\tl-12.433,2.806l85.613-75.406l49.986,45.269v0.218h0.236l32.51,29.447L170.409,98.344z"/>\r\n\t</g>\r\n</svg>\r\n',ot='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0.138877272605896 24.26899528503418 99.864013671875 45.71800231933594">\r\n  <path d="M49.701 40.913a10.246 10.246 0 0 0 1.557-0.573c0.487-0.229 0.895-0.498 1.215-0.809 0.521-0.505 0.609-0.881 0.254-1.126-0.353-0.246-1.159-0.463-2.424-0.652l-3.882 3.685a17.53 17.53 0 0 0 1.587-0.164 13.571 13.571 0 0 0 1.693-0.361zM51.33 34.744l3.326-3.112a10.62 10.62 0 0 0-2.728 0.456 8.08 8.08 0 0 0-1.296 0.513 4.43 4.43 0 0 0-1.027 0.698c-0.451 0.416-0.539 0.73-0.265 0.948 0.281 0.215 0.943 0.382 1.99 0.497z" fill="#1DCA7F" data-fill-palette-color="accent"></path>\r\n  <path d="M75.028 49.957c0.348 0 0.679-0.138 0.925-0.382l23.665-23.077a1.304 1.304 0 0 0-0.923-2.229h-72.69c-0.315 0-0.619 0.113-0.857 0.32L0.589 47.666a1.305 1.305 0 0 0 0.858 2.291h73.581zM37.502 38.996l5.334-0.042c-0.807 0.717-1.043 1.281-0.714 1.693 0.333 0.415 1.015 0.679 2.053 0.792l4.264-3.989a6.866 6.866 0 0 0-0.415-0.079 12.446 12.446 0 0 0-0.605-0.078c-0.79-0.114-1.547-0.25-2.264-0.408-0.716-0.157-1.276-0.37-1.679-0.642-0.407-0.268-0.591-0.607-0.554-1.016 0.04-0.408 0.403-0.923 1.093-1.543 0.704-0.633 1.565-1.198 2.589-1.696 1.021-0.5 2.109-0.927 3.267-1.283a29.396 29.396 0 0 1 3.591-0.864 33.531 33.531 0 0 1 3.584-0.445l1.565-1.466 2.194-0.087-1.561 1.475c1.043 0.026 1.957 0.115 2.739 0.268 0.786 0.156 1.376 0.387 1.775 0.694 0.403 0.309 0.583 0.705 0.548 1.189-0.035 0.485-0.361 1.066-0.984 1.747l-5.31 0.125c0.517-0.517 0.663-0.948 0.445-1.292-0.221-0.343-0.749-0.502-1.595-0.478l-3.596 3.398c0.26 0.032 0.521 0.064 0.794 0.096 0.272 0.033 0.551 0.073 0.847 0.118 1.581 0.224 2.668 0.521 3.273 0.887 0.604 0.37 0.929 0.762 0.977 1.174 0.049 0.414-0.093 0.83-0.432 1.25-0.342 0.42-0.678 0.793-1.01 1.123-0.295 0.288-0.801 0.653-1.527 1.093-0.719 0.44-1.656 0.871-2.803 1.29-1.15 0.416-2.499 0.786-4.046 1.105-1.551 0.318-3.312 0.505-5.276 0.561l-1.727 1.631-2.263-0.021 1.733-1.622c-2.734-0.116-4.481-0.559-5.24-1.328-0.754-0.761-0.441-1.868 0.936-3.33z" fill="#1DCA7F" data-fill-palette-color="accent"></path>\r\n  <path d="M76.558 54.748H0.45v5.226h77.191c0.69 0 1.355-0.275 1.846-0.766L100 38.884v-7.58L76.558 54.748z" fill="#1DCA7F" data-fill-palette-color="accent"></path>\r\n  <path d="M0.45 64.761v5.226h79.804c0.691 0 1.356-0.276 1.846-0.766L100 51.398v-7.467l-20.826 20.83H0.45z" fill="#1DCA7F" data-fill-palette-color="accent">\r\n  </path>\r\n</svg>\r\n',it='<?xml version="1.0"?>\r\n<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">\r\n  <g>\r\n    <path d="M28,17H4a1,1,0,0,1,0-2H28a1,1,0,0,1,0,2Z"/>\r\n    <path d="M16,29a1,1,0,0,1-1-1V4a1,1,0,0,1,2,0V28A1,1,0,0,1,16,29Z"/>\r\n  </g>\r\n</svg>',st=Object.defineProperty,nt=Object.getOwnPropertyDescriptor,lt=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?nt(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&st(e,r,i),i};class ct extends C{clickedLogin(){const t=this.emailInput.value,e=this.passwordInput.value;t&&e&&(this.passwordInput.value="",this.dispatchEvent(new CustomEvent("clicked-login",{detail:{email:t,password:e}})))}firstUpdated(){q(this.emailInput,(()=>this.clickedLogin())),q(this.passwordInput,(()=>this.clickedLogin()))}render(){return I`
    ...
    `}updated(){var t;const e={};if(Object.keys(dt).forEach((t=>{const r=this.entries.filter((e=>e.month===t));e[t]=Dt(r)})),!this.chart)return;const r={type:"bar",data:{labels:ht.map((t=>gt(t))),datasets:[{data:Object.values(e),backgroundColor:"#1DCA7F",hoverBackgroundColor:"#FFF",borderColor:"#444",borderWidth:1,barPercentage:1,categoryPercentage:1}]},options:{color:"#FFF",responsive:!0,maintainAspectRatio:!1,layout:{padding:0},plugins:{legend:{display:!1}}}};null==(t=this.chartInstance)||t.destroy(),this.chartInstance=new N(this.chart,r)}static get styles(){return[x(Q),f`
      ...
      `]}}Rt([O()],Pt.prototype,"entries",2),Rt([w("#chart")],Pt.prototype,"chart",2);var Vt=Object.defineProperty,Ht=Object.getOwnPropertyDescriptor,Ft=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?Ht(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&Vt(e,r,i),i};class jt extends C{render(){return I`
      <div>
        <canvas id="chart"></canvas>
      </div>
    `}updated(){var t;const e={};if(Object.keys(dt).forEach((t=>{const r=this.entries.filter((e=>e.month===t));e[t]=St(r)})),!this.chart)return;const r={type:"bar",data:{labels:ht.map((t=>gt(t))),datasets:[{data:Object.values(e),backgroundColor:"#FF0000",hoverBackgroundColor:"#FFF",borderColor:"#444",borderWidth:1,barPercentage:1,categoryPercentage:1}]},options:{color:"#FFF",responsive:!0,maintainAspectRatio:!1,layout:{padding:0},plugins:{legend:{display:!1}}}};null==(t=this.chartInstance)||t.destroy(),this.chartInstance=new N(this.chart,r)}static get styles(){return[x(Q),f`
      ...
      `]}}Ft([O()],jt.prototype,"entries",2),Ft([w("#chart")],jt.prototype,"chart",2);var Ut=Object.defineProperty,Wt=Object.getOwnPropertyDescriptor,zt=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?Wt(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&Ut(e,r,i),i};class Bt extends C{render(){return I`
      <div>
        <canvas id="chart"></canvas>
      </div>
    `}updated(){var t;const e={};if(Object.keys(dt).forEach((t=>{const r=this.entries.filter((e=>e.month===t));e[t]=Tt(r)})),!this.chart)return;const r={type:"bar",data:{labels:ht.map((t=>gt(t))),datasets:[{data:Object.values(e),backgroundColor:"#6898AE",hoverBackgroundColor:"#FFF",borderColor:"#444",borderWidth:1,barPercentage:1,categoryPercentage:1}]},options:{color:"#FFF",responsive:!0,maintainAspectRatio:!1,layout:{padding:0},plugins:{legend:{display:!1}}}};null==(t=this.chartInstance)||t.destroy(),this.chartInstance=new N(this.chart,r)}static get styles(){return[x(Q),f`
      ...
      `]}}zt([O()],Bt.prototype,"entries",2),zt([w("#chart")],Bt.prototype,"chart",2);var Yt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,Xt=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?Kt(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&Yt(e,r,i),i};class Zt extends C{render(){return I`
      <div>
        <canvas id="chart"></canvas>
      </div>
    `}updated(){var t;if(!this.chart)return;const e=Mt(this.entries),r=Object.values(e).map((t=>t.amount)).reduce(((t,e)=>t+e),0),a={type:"doughnut",data:{labels:[...Object.entries(e).map((([t,e])=>`${Nt(t)} (${parseFloat((e.amount/r*100).toString()).toFixed(2)} %)`))],datasets:[{data:[...Object.values(e).map((t=>t.amount))],backgroundColor:[...Object.values(e).map((t=>t.color))],borderColor:"#444",borderWidth:1}]},options:{color:"#FFF",responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!0,position:"left",align:"end"}}}};null==(t=this.chartInstance)||t.destroy(),this.chartInstance=new N(this.chart,a)}static get styles(){return[x(Q),f`
        :host {
          display: flex;
        }
        div {
      ...
      `]}}Xt([O()],Zt.prototype,"entries",2),Xt([w("#chart")],Zt.prototype,"chart",2);var Jt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,Qt=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?qt(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&Jt(e,r,i),i};class te extends C{render(){return I`
      <div>
        <canvas id="chart"></canvas>
      </div>
    `}updated(){var t;const e={};if(Object.keys(dt).forEach((t=>{const r=this.entries.filter((e=>e.month===t));e[t]=Dt(r)-St(r)-Tt(r)})),!this.chart)return;const r={type:"bar",data:{labels:ht.map((t=>gt(t))),datasets:[{data:Object.values(e),backgroundColor:"#666",hoverBackgroundColor:"#FFF",borderColor:"#444",borderWidth:1,barPercentage:1,categoryPercentage:1}]},options:{color:"#FFF",responsive:!0,maintainAspectRatio:!1,layout:{padding:0},plugins:{legend:{display:!1}}}};null==(t=this.chartInstance)||t.destroy(),this.chartInstance=new N(this.chart,r)}static get styles(){return[x(Q),f`
        :host {
          display: flex;
        }
        div {
      ...
      `]}}Qt([O()],te.prototype,"entries",2),Qt([w("#chart")],te.prototype,"chart",2);var ee=Object.defineProperty,re=Object.getOwnPropertyDescriptor,ae=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?re(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&ee(e,r,i),i};class oe extends C{constructor(){super(),this.currentYear=(new Date).getUTCFullYear(),this.tooltipText=k('Charts on this page are not comparable in terms of scale, to compare charts please look at the Y axis too!<br/><br/>The expenses and savings may not add up to the total income listed on this page, a portion of the income may not be allocated to an expense nor a saving. You can find further details on the "Monthly Overview" page for that month.'),_("income-chart",$(Pt)()),_("expenses-chart",$(jt)()),_("savings-chart",$(Bt)()),_("distribution-chart",$(Zt)()),_("netto-chart",$(te)())}render(){var t;const e=null==(t=this.entries)?void 0:t.filter((t=>this.currentYear===t.year));return I`
      <div class="pane">
        <div class="title">
          <h2>Income</h2>
          <div>
    ...
    `}static get styles(){return[x(Q),f`
      ...
      `]}}ae([O()],oe.prototype,"currentYear",2),ae([O()],oe.prototype,"entries",2);class ie extends C{clickedLogout(){this.dispatchEvent(new CustomEvent("clicked-logout"))}render(){return I`
    ...
    `}static get styles(){return[x(Q),f`
      ...
      `]}}((t,e,r,a)=>{for(var o,i=a>1?void 0:a?le(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);a&&i&&ne(e,r,i)})([O()],ce.prototype,"state",2);var de=Object.defineProperty,pe=Object.getOwnPropertyDescriptor,he=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?pe(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&de(e,r,i),i};class ge extends C{constructor(){super(...arguments),this.showMenu=!1}selected(t){this.value.innerText=this.options[t],this.dispatchEvent(new CustomEvent("selected",{detail:t}))}toggleMenu(){this.showMenu=!this.showMenu}firstUpdated(){this.container.addEventListener("click",(()=>{this.toggleMenu()}))}render(){return I`
      <div class="container">
    ...
    `}static get styles(){return[x(Q),f`
      ...
      `]}}he([O()],ge.prototype,"options",2),he([O()],ge.prototype,"showMenu",2),he([w(".container")],ge.prototype,"container",2),he([w(".menu")],ge.prototype,"menu",2),he([w(".value")],ge.prototype,"value",2);var ve=Object.defineProperty,ue=Object.getOwnPropertyDescriptor,me=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?ue(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&ve(e,r,i),i};class ye extends C{constructor(){super(...arguments),this.showMenu=!1,this.selectedItems=[],this.selectedItemsValue=[]}selected(t,e){this.selectedItems=this.selectedItems.includes(t)?this.selectedItems.filter((e=>e!==t)):[...this.selectedItems,t],this.dispatchEvent(new CustomEvent("selected",{detail:this.selectedItems})),this.selectedItemsValue=this.selectedItems.map((t=>this.options[t]))}toggleMenu(){this.showMenu=!this.showMenu,this.container.style.border=this.showMenu?"1px solid var(--colors-primary-dark)":"none",this.container.style.borderRadius=this.showMenu?"var(--gap-small) var(--gap-small) 0 0":"var(--gap-small)",this.svg.style.transform=this.showMenu?"rotate(180deg)":"none"}reset(){this.selectedItems=[],this.selectedItemsValue=[],this.dispatchEvent(new CustomEvent("selected",{detail:[]}))}firstUpdated(){this.valueContainer.addEventListener("click",(()=>{this.toggleMenu()}))}render(){return I`
      <div class="container">
    ...
    `}static get styles(){return[x(Q),f`
      ...
      <div class="inputs">
        ...
        <custom-select
          ...
          .options="${Object.keys(vt).reduce(((t,e)=>i(i({},t),{[e]:Nt(e)})),{})}"
        >
        </custom-select>
        <p>Extra categories:</p>
        <custom-select-multiple
          @selected="${t=>this.extraCats=t.detail}"
          .options="${Object.keys(this.mainCatValue===Ot.SAVINGS?ft:i(i({},this.mainCatValue===Ot.EXPENSE?i(i({},Ct),At):Et),mt)).reduce(((t,e)=>i(i({},t),{[e]:Nt(e)})),{})}"
        >
        </custom-select-multiple>
        <p>Amount:</p>
    ...
    `}static get styles(){return[x(Q),f`
      ...
      <p>${this.entry.categories.filter((t=>![Ot.INCOME,Ot.EXPENSE,Ot.SAVINGS].includes(t))).map((t=>Nt(t))).join(", ")}</p>
    ...
    `}static get styles(){return[x(Q),f`
      ...
      `]}}((t,e,r,a)=>{for(var o,i=a>1?void 0:a?Ie(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);a&&i&&Ce(e,r,i)})([O()],Ae.prototype,"entry",2);var xe=Object.defineProperty,Oe=Object.getOwnPropertyDescriptor;class Ne extends C{clickedBack(){this.dispatchEvent(new CustomEvent("go-back"))}clickedAdd(t){this.dispatchEvent(new CustomEvent("clicked-add",{detail:t}))}render(){var t;return I`
      <div class="title">
        ...
        <div class="list">
          ${this.entries.sort(((t,e)=>e.amount-t.amount)).map((t=>I`
            <div class="entry">
              <p>${Gt(t.amount)}</p>
              <p>
                ${t.categories.filter((t=>![Ot.RECURRING,Ot.EXPENSE].includes(t))).map((t=>Nt(t))).join(", ")}
              </p>
      ...
      <div class="addContainer">
        ...
        <div class="pane">
          <recurring-component
            ...
            @clicked-add="${t=>this.clickedAdd(t)}"
            .entries="${this.entries.filter((t=>t.categories.includes(Ot.RECURRING))).filter(((t,e,r)=>r.filter((e=>{return r=e,t.categories.every((t=>kt(r,t)));var r})).every((e=>Date.parse(`1 ${t.month} ${t.year}`)>=Date.parse(`1 ${e.month} ${e.year}`))))).filter((t=>!this.filtered.find((e=>e.categories.every((e=>t.categories.includes(e)))))))}"
          ></recurring-component>
        </div>
      </div>
    ...
    `}static get styles(){return[x(Q),f`
      ...
      `]}}De([w("#dateInput")],Se.prototype,"input",2),De([w("#addPane")],Se.prototype,"addPane",2),De([w("#bar-chart")],Se.prototype,"barChart",2),De([w("#pie-chart")],Se.prototype,"pieChart",2),De([w(".addContainer")],Se.prototype,"addContainer",2),De([O()],Se.prototype,"entries",2),De([O()],Se.prototype,"selectedMonth",2),De([O()],Se.prototype,"selectedYear",2),De([O()],Se.prototype,"filtered",2),De([O()],Se.prototype,"totalIncome",2),De([O()],Se.prototype,"totalExpenses",2),De([O()],Se.prototype,"totalSavings",2),De([O()],Se.prototype,"totalNetto",2);var Te=Object.defineProperty,Ge=Object.getOwnPropertyDescriptor,Me=(t,e,r,a)=>{for(var o,i=a>1?void 0:a?Ge(e,r):e,s=t.length-1;s>=0;s--)(o=t[s])&&(i=(a?o(e,r,i):o(i))||i);return a&&i&&Te(e,r,i),i};class _e extends C{constructor(){super(),N.register(...L),_("login-page",$(ct)()),_("home-page",$(oe)()),_("monthly-page",$(Se)()),_("page-header",$(ie)()),_("loading-bar",$(se)()),_("sidebar-component",$(ce)()),this.machine=D(J).withContext({data:[]}),this.actor=S(this.machine).onTransition((t=>console.log("STATE: ",t.value))),this.subscribe("state",T(this.actor)),this.subscribe("entries",T(this.actor).pipe(G((t=>t.context.data)))),this.actor.start()}clickedLogin(t){this.actor.send(new z(t.detail.email,t.detail.password))}clickedLogout(){this.actor.send(new B)}clickedHome(){this.actor.send(new Y)}clickedMonthly(){this.actor.send(new K)}clickedAddEntry(t){this.actor.send(new X(t.detail))}clickedDelete(t){this.actor.send(new Z(t.detail))}render(){var t,e,r,a,o,i,s,n;return I`
    ...
    `}static get styles(){return[x(Q),f`
      ...
      `]}}Me([O()],_e.prototype,"state",2),Me([O()],_e.prototype,"entries",2),M({apiKey:"AIzaSyAL-nNMVRScFecxz2HymYpxtr_o8mO3KXA",authDomain:"yabat-e3d19.firebaseapp.com",projectId:"yabat-e3d19",storageBucket:"yabat-e3d19.appspot.com",messagingSenderId:"658164896532",appId:"1:658164896532:web:3b4d16d313681ef1032801"}),_("app-root",$(_e)());
