...
export class HomePageComponent extends RxLitElement {
    constructor() {
        ...
        this.tooltipText = unsafeHTML('Charts on this page are not comparable in terms of scale, to compare charts please look at the Y axis too!<br/><br/>The expenses and savings may not add up to the total income listed on this page, a portion of the income may not be allocated to an expense nor a saving. You can find further details on the "Monthly Overview" page for that month.');
    ...
    render() {
        var _a;
        const filtered = (_a = this.entries) === null || _a === void 0 ? void 0 : _a.filter(e => this.currentYear === e.year);
        return html `
      <div class="pane">
        <div class="title">
          <h2>Income</h2>
...
__decorate([
    state()
], HomePageComponent.prototype, "currentYear", void 0);
__decorate([
    state()
], HomePageComponent.prototype, "entries", void 0);
